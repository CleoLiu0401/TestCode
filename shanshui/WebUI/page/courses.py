...
class Courses(BasePage):
    __BUTTON_ADD = (By.CSS_SELECTOR, ".n-button--primary-type > .n-button__content")
    ...
    def add_course(self, course_name):
        ...
        self.do_click(By.CSS_SELECTOR, ".n-tree-node-switcher__icon svg")
        ...
        self.do_click(By.CSS_SELECTOR, ".n-radio-input")
        ...
        self.do_click(By.CSS_SELECTOR, ".n-tree-node-wrapper:nth-child(3) .n-tree-node-content__text")  # 树
        self.do_click(By.CSS_SELECTOR, ".n-radio-input")
        ...
        # 勾选教材邮寄
        self.do_click(By.CSS_SELECTOR, "div:nth-child(23) .n-checkbox-box__border")
        # 勾选积分抵现
        self.do_click(By.CSS_SELECTOR, "div:nth-child(25) .n-checkbox-box__border")
        # 保存
